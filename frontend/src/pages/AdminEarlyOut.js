  ...
  return (
    <div className="space-y-6 animate-fade-in" data-testid="admin-early-out-page">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => setShowApply(true)} className="bg-[#063c88] hover:bg-[#052d66] text-white rounded-xl" data-testid="admin-apply-early-out-btn"><Plus className="w-4 h-4 mr-2" /> Apply for Employee</Button>
      </div>
