              ...
              <table className="w-full border-collapse min-w-max">
                <thead className="sticky top-0 z-20">
                  <tr>
                    ...
                    <th className="px-2 py-3 text-center text-[11px] font-semibold text-indigo-700 bg-indigo-100 min-w-[100px] whitespace-nowrap">Weekoff Pay / Holiday Pay</th>
                  ...
                  {payrollData.length === 0 ? (
                    ...
                    payrollData.map((emp, index) => (
                      <tr key={emp.employee_id} className="border-t border-slate-100 hover:bg-slate-50/50">
                        ...
                        <td className="px-3 py-2 text-center text-sm font-medium text-indigo-600 bg-indigo-50">{(emp.weekoff_pay || 0) + (emp.oh_pay || 0)}</td>
